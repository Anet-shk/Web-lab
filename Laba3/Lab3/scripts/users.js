...
import { default as users } from "./additionalScript3Lab/actionForUsers.js";
...
console.log({ myValidatedUsers });

users.sortUsers = sortUsers.bind(null, myValidatedUsers); // second argument is field, which will be sorted, third is direction (boolean)}
users.filterUsers = filterUsers.bind(null, myValidatedUsers); // second argument is object, like: {name: 'Ann'}
users.findUser = findUserByField.bind(null, myValidatedUsers); // second argument is object, like: {age: 50}
users.percentageFilters = percentageFilterUsers.bind(null, myValidatedUsers); // second argument is object, like: {name: 'Ann'}
