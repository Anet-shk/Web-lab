...
function doFilterCountry(filtersCountry) {
  ...
  users.currentList = users.filterUsers({country: filtersCountry.value});
  renderUi();
}
...
function doFilterAge(filtersAge) {
  ...
  users.currentList = users.filterUsers({age: value});
  renderUi();
}
...
function doFilterGender(filtersGender) {
  ...
  // debugger
  users.currentList = users.filterUsers({gender: filtersGender.value});
  renderUi();
}
